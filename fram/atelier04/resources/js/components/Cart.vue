 ...
 <div v-if="cart.length > 0" style="display:flex">
   ...
   <table>
    <tr v-for="(c) of cart" :key="c.id">
      <td><img :src="require(`../assets/images/${c.imageartpetitf}`)" :alt="c.designation" width="50"></td>  
      <td>{{ c.designation }}</td>
      <td>{{ c.price }} TND </td>
     ...
     <div class="col-10">
        ...
        <router-link :to="{name: 'Home'}" > <button class="btn btn-success"> MORE </button> </router-link>     
